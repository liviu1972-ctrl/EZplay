...
Sursele Next.js, Deckbuilder-ul și simulatorul integrat sunt în acest repository. Inspectează `src/`, `supabase/`, `package.json` și regulile locale înainte de a propune instalări, reorganizări sau schimbări de arhitectură.
