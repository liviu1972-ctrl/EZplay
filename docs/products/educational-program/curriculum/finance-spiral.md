...
Acest document este prima schiță a progresiei curriculare Finance pentru programul de educație antreprenorială EZPLAY.

Nu este încă:

- curriculum complet;
- programă pe grupe de vârstă;
- listă de Founder Rounds gata de livrare;
...
Finance nu evoluează de la „teorie” la „decizie” abia spre final. Participantul ia decizii încă de la Level 1. Pe măsură ce avansează, cresc:

- numărul variabilelor și perioadelor;
- legăturile cu celelalte perspective;
- incertitudinea;
- autonomia;
...
### Spirala este dată de reveniri

O listă `Money → Statements → Performance → Decisions → Leadership` ar descrie o succesiune elegantă, dar încă liniară. Pentru a fi spirală, Profit, Cash, risc, performanță și decizie trebuie să reapară, de fiecare dată cu legături și cerințe mai puternice.

## Progresia propusă

### Finance Level 1 — Banii companiei

**Întrebarea fondatorului:** De unde vin banii companiei și unde se duc?

**Capacitate centrală:** Participantul poate urmări intrările și ieșirile simple, poate separa Revenue de Expenses și poate explica rezultatul unei alegeri economice de bază.
...
- Expenses;
- Profit;
- Cash ca resursă disponibilă.

**Reveniri și decizii:** Participantul compară alternative, observă compromisuri simple și decide ce poate cumpăra, produce sau vinde cu resurse limitate. Nu este suficient să recunoască vocabularul.

**Dovezi posibile:** urmărește corect banii într-un Business Run; explică de ce o companie a câștigat sau a pierdut bani; alege între două opțiuni și descrie consecința financiară imediată.

**Instrumente probabile:** Deckbuilder, materiale fizice, hărți vizuale ale banilor și probleme scurte. Deckbuilder este potrivit aici deoarece face resursele și rezultatele vizibile, fără a cere situații financiare formale.
...
**Concepte revizitate:** Revenue, Expenses și Profit sunt urmărite în timp, nu numai ca total final.
...
| Cash și Cash Flow | observă resursa disponibilă | anticipează blocajul | conectează situațiile | explică lichiditatea și Working Capital | estimează nevoia de finanțare | evaluează reziliența și capitalul |
...
| Performanță | vede rezultat simplu | compară Profit cu supraviețuirea | folosește trei perspective contabile | selectează indicatori | proiectează ținte și scenarii | evaluează crearea de valoare |
...
- Working Capital poate cere înțelegerea ciclului operațional;
- valoarea pe termen lung cere alegeri strategice și nu poate fi redusă la un model financiar;
- performanța Finance poate fi consecința unei probleme din altă perspectivă.

Aceste exemple nu stabilesc încă niveluri minime. Harta exactă de prerechizite se construiește odată cu Founder Rounds, pentru a porni de la dependențe reale.

## Competențe și evidențe

Fiecare capacitate centrală trebuie descompusă ulterior în competențe observabile. Pentru fiecare competență vor fi necesare:

- condiția și contextul;
- acțiunea observabilă;
- calitatea minimă acceptată;
...
Tema existentă `Profit, Cash și Cash Flow` se potrivește cel mai bine, provizoriu, în Finance Level 2. Această poziționare este o inferență de design, nu o decizie validată.

Pentru primul prototip trebuie clarificate:

1. ce experiență minimă de Level 1 sau onboarding este necesară;
2. competența exactă urmărită, nu doar lista conceptelor;
