...
- [`active/curriculum-explorer.md`](active/curriculum-explorer.md) — zona publică structurată a programului, cu shell curricular propriu, rute sub `/program/curriculum` și graniță explicită între sursa internă și conținutul public;
