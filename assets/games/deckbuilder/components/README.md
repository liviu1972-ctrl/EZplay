# Componente vizuale Deckbuilder

Aici intră elementele reutilizabile ale jocului, distincte de layout-urile finale ale cărților și de colile trimise la tipar:

- iconuri economice și de joc;
- bani, monede și tokenuri;
- elemente grafice comune mai multor cărți;
