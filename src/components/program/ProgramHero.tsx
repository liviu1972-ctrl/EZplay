  ...
  return (
    <section className="relative w-full overflow-hidden bg-surface py-16 md:py-24 lg:py-32">
      <div className="container relative z-10 flex flex-col items-start max-w-[1000px] mx-auto px-4 md:px-8">
        ...
        <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold text-ink tracking-tight mb-8 animate-scale-up" style={{ animationDelay: "100ms" }}>
          Un program care crește <br className="hidden md:inline" />
          odată cu participantul.
        </h1>
        
        <p className="text-lg md:text-xl text-ink-muted leading-relaxed mb-10 max-w-[75ch] animate-fade-in" style={{ animationDelay: "200ms" }}>
        ...
        <div className="p-4 rounded-xl border border-line-strong bg-surface-soft text-sm text-ink-muted animate-fade-in" style={{ animationDelay: "400ms" }}>
