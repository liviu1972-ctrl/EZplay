...
- Sursa canonică pentru formule este `docs/methods/economic-model.md`; în perioada migrării folosește temporar `docs/new site/docs/methods/economic-model.md`.
